...
import '../models/agendamento.dart'; // ✅ IMPORT NECESSÁRIO
                ...
                Expanded(
                  child: Text(
                    chosen == null
                        ...
                        : DateFormat("dd/MM/yyyy HH:mm").format(chosen!),
                  ),
                ),
                TextButton(
                  onPressed: () async {
            ...
            Expanded(
              child: ListView.builder(
                ...
                itemBuilder: (_, i) {
                  ...
                  final p = products.items
                      .firstWhere((x) => x.id == e.produtoId);

                  return ListTile(
                    title: Text(p.nome),
                    subtitle:
                        Text(DateFormat("dd/MM/yyyy HH:mm").format(e.hora)),
                    trailing: IconButton(
                      icon: const Icon(Icons.delete),
                      onPressed: () => schedule.removeEntry(e),
                    ),
                  );
                },
              ),
